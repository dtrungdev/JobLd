        ...
        <header className={cl("wrapper")}>
            <div className={cl("inner")}>
                ...
                <div className={cl("nav-right")}>
                    ...
                    <span className={cl("notify")}>
                        <i
                            className={cl("fa-solid fa-bell", "notify-icon")}
                        ></i>
                        <span className={cl("notify-numbers")}>1</span>
                    </span>
                    {isLogined ? (
                ...
                <Offcanvas show={show} onHide={handleClose}>
                    <Offcanvas.Header
                        className={cl("offcanvas-header")}
                        closeButton
                    >
                        <Image src={logo} width={40} height={40} alt="Logo" />
                        <Offcanvas.Title className={cl("offcanvas-title")}>
                            JobLd
                        </Offcanvas.Title>
                    </Offcanvas.Header>
                    <Offcanvas.Body className={cl("offcanvas-body")}>
                        <a className={cl("body-item")}>Đăng ký tài khoản mới</a>
                        <a className={cl("body-item")}>Đăng nhập</a>
                        <a className={cl("body-item")}>Việc làm</a>
                        <a className={cl("body-item")}>Hồ sơ và CV</a>
                        <a className={cl("body-item")}>Công ty</a>
                        <a className={cl("body-item")}>Blog</a>
                    </Offcanvas.Body>
                </Offcanvas>
            </div>
        </header>
