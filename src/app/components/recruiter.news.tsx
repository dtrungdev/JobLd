                        ...
                        <tr>
                            ...
                            <th>
                                <div className={cl('d-flex', 'justify-content-center')}>
                                    ...
                                    <i className={cl('fa-solid fa-gear')} style={{fontSize: '1.8rem'}}></i>
                                </div>
                            </th>
                        ...
                        <tr className={cl('field-data')}>
                            ...
                            <td>
                                <div className={cl('d-flex', 'flex-column', 'gap-4')}>
                                    <i className={cl('fa-solid fa-pen', 'icon-action')} title='Chỉnh sửa'></i>
                                     <i className={cl('fa-solid fa-pause', 'icon-action')} title='Tạm dừng'></i>
                                      <i className={cl('fa-solid fa-tr', 'icon-action')} title='Xóa'></i>
