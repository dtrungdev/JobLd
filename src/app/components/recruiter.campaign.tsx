...
import styles from '../styles/recruiterCampaign.module.scss'
import { useRef } from 'react';
import { useEffect } from 'react';
import { useState } from 'react';

import Editor from '../components/textSlider'
                ...
                <div className={cl('content-mini')}>
                    <div className={cl('d-flex', 'flex-column')}>
                        <div className={cl('component')}>
                            ...
                            <i className={cl('fa-solid fa-pen', 'component-icon')}></i>
                        </div>
                        <div className={cl('component')}>
                            ...
                            <div className={cl('d-flex', 'gapping')}>
                             ...
                             <i className={cl('fa-solid fa-folder', 'component-icon')}></i>
                        </div>
                        <div className={cl('component')}>
                            ...
                            <div className={cl('d-flex', 'gapping')}>
                                ...
                                <div className={cl('form-group')}>
                                    <label className={cl('label')}>
                                        Loại công việc <i className={cl('fa-solid fa-circlw-question')}></i> />
                                    </label>
                                    <Selection
                                ...
                                >
                                    <div className={cl('form-group', 'd-flex', 'align-items-center')}>
                                        <label className={cl('label-horizontal')}>
                                            <i className={cl('fa-solid fa-location-dot')}></i> Khu vực 1:
                                        </label>
                                        <Selection
                                    ...
                                    <div className={cl('add-address')}>
                                        <i className={cl('fa-solid fa-plus')}></i> Thêm địa chỉ
                                    </div>
                                </div>
                            </div>
                        <i className={cl('fa-solid fa-circle-info', 'component-icon')}></i>
                        </div>
                        <div className={cl('component')}>
                            ...
                            <div className={cl('d-flex')}>
                             ...
                             <i className={cl('fa-solid fa-thumbs-up', 'component-icon')}></i>
                        </div>
                        <div className={cl('component')}>
                            ...
                            <div className={cl('d-flex', 'position-r')}>
                             ...
                             <i className={cl('fa-solid fa-align-left', 'component-icon')}></i>
                        </div>
                        <div className={cl('component')}>
                        ...
                        <div className={cl('component')}>
                            ...
                            <div className={cl('d-flex', 'gapping', 'position-r')}>
                             ...
                             <i className={cl('fa-solid fa-briefcase', 'component-icon')}></i>
                        </div>
                        ...
                        <div className={cl('component')}>
                            ...
                            <p>Bổ sung hình ảnh/video sẽ giúp công ty hiển thị được chuyên nghiệp hơn</p>
                             ...
                             <i className={cl('fa-solid fa-image', 'component-icon')}></i>
                        </div>
