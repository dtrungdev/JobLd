...
import styles from '../../styles/recruiterRegister.module.scss'
                        ...
                        <div className={cl('auth-form')}>
                            ...
                            <div className={cl('register')}>
                                {isContinueRegister == false ? (
                                    <div className={cl('register-form')}>
                                        ...
                                        <div className={cl('form-group')}>
                                            ...
                                            >
                                                ...
                                                <span className={cl('icon-box', 'hide-password')}>
                                                        ...
                                                        <i className={isShowPassword?cl('fa-solid fa-eye-slash'):cl('fa-solid fa-eye')} onClick={()=>setIsShowPassword(!isShowPassword)}></i>
                                                </span>
                                            </div>
                                        </div>
                                        <div className={cl('form-group')}>
                                        ...
                                        >
                                            ...
                                            <i className={cl('fa-solid fa-chevron-right', 'continue-icon')}></i>
                                        </Button>
                                    </div>
                                ) : (
                                    <div className={cl('register-form')}>
                                        ...
                                        <div className={cl('d-flex', 'justify-content-between')}>
                                            <div className={cl('form-group')}>
                                                ...
                                                >
                                                    <span className={cl('icon-box')}>
                                                            <i className={cl('fa-solid fa-user')}></i>
                                        ...
                                        <div className={cl('form-group')}>
                                            ...
                                            >
                                                <span className={cl('icon-box')}>
                                                    <i className={cl('fa-solid fa-phone')}></i>
                                        ...
                                        <div className={cl('form-group')}>
                                            ...
                                            >
                                                <span className={cl('icon-box')}>
                                                    <i className={cl('fa-solid fa-building')}></i>
                                                </span>
                                                <input
                                                    type="text"
                                                    name=""
                                ...
                                <div className={cl('footer', 'text-center')}>
                                    ...
                                    <Link href={"/recruiter/login"}  className={cl('text-success')}>
                                        Đăng nhập ngay
                                    </Link>
